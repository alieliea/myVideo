		...
		<script type="text/javascript">
			function imgNew() {
				document.getElementById("img").setAttribute("src",
						"${back_url}login/captcha/" + (new Date()).getMilliseconds());
			}
		</script>	
											...
											<div class="form-group">
												<div class="row">
													<div class="col-sm-9">
														<label>验证码</label>
														<div class="input-group input-group-icon">
															<input type="text" class="form-control" name="captcha" id="captcha" placeholder="请输入验证码" required/>
														</div>
													</div>
													<div class="col-sm-3">
														<label>&nbsp;</label>
														<div class="input-group input-group-icon">
															<img src="${back_url}login/captcha" style="border-radius:3px;height: 33px;width: 75px;" onclick="imgNew();" id="img">
														</div>
													</div>
												</div>
											</div>
