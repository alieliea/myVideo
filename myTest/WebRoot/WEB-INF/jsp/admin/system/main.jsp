					...
					<div class="userbox">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<figure class="profile-picture hidden-xs">
								<c:choose>
									<c:when test="${loginuser.userhead==null || loginuser.userhead==''}">
										<img src="${base_url }assets/img/avatar4.jpg" class="img-circle" alt="" />
									</c:when>
									<c:otherwise>
										<img src="${base_url }${loginuser.userhead}" class="img-circle" alt="" />
									</c:otherwise>
								</c:choose>
							</figure>
...
<!-- 								<span class="role"><i class="fa fa-circle bk-fg-success"></i>程序猿</span> -->
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li data-addtab="menu" title="menu" url="${back_url }menu">
									<a><i class="fa fa-user"></i>用户信息</a>
								</li>
								<li>
									<a><i class="fa fa-wrench"></i>修改密码</a>
								</li>
								<li>
									<a href="${back_url }login/logOut"><i class="fa fa-power-off"></i>注销</a>
								</li>
							</ul>
						</div>
					</div>
